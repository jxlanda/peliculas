...
//
//     final actores = actoresFromJson(jsonString);

import 'dart:convert';

Actores actoresFromJson(String str) => Actores.fromJson(json.decode(str));

String actoresToJson(Actores data) => json.encode(data.toJson());
